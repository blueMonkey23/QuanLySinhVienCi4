...
<body>
              ...
              <form id="edit_class_form">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="subject_id" name="subject_id" required><option value="">Đang tải...</option></select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="teacher_id" name="teacher_id" required><option value="">Đang tải...</option></select>
  ...
  <script src="<?= base_url('assets/js/manager_class_edit.js') ?>"></script> 
</body>
</html>